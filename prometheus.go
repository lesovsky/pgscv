...
var (
	...
	statdesc = []*StatDesc{
		...
		{Name: "pg_schema_redundant_index", Query: pgSchemaRedundantIndexesQuery, ValueNames: []string{"bytes"}, LabelNames: []string{"datname", "schemaname", "relname", "index", "redundant"}, Schedule: Schedule{Interval: 5 * time.Minute}},
