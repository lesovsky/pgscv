...
func globalHelpCatalog() map[string]string {
	return map[string]string{
		...
		"pg_stat_activity_max_seconds":                          "Duration of the longest transaction or query, in seconds",
		"pg_stat_activity_idle_xact_max_seconds":                "Duration of the longest idle transaction (active or failed), in seconds",
		"pg_stat_activity_wait_max_seconds":                     "Duration of the longest transaction or query which is waiting, in seconds",
		// pg_stat_statements
