...
func TestMeminfoCollector_Update(t *testing.T) {
	var input = pipelineInput{
		required: []string{
			"node_memory_MemTotal", "node_memory_MemFree", "node_memory_MemAvailable",
			...
			"node_memory_SwapTotal", "node_memory_SwapFree", "node_memory_Dirty",
			"node_memory_Writeback", "node_memory_AnonPages", "node_memory_Mapped",
